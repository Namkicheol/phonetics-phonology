<iframe src="https://namkicheol.github.io/phonetics-phonology/aspiration_study.html" width="100%" height="1000" style="border: none; border-radius: 10px;"></iframe>
...
**AEP의 rule description**: syllable-initial voiceless stop은 뒤의 stressed vowel 앞에서 [+aspirated]로 실현되며, onset 안에는 선택적으로 consonant가 하나 개재할 수 있다.
...
```
/p, t, k/ → [pʰ, tʰ, kʰ] / ___ (C) V́
            (syllable onset 안에서, 선택적 개재 consonant와 stressed vowel 앞)
```

핵심은 onset과 stressed vowel 사이에 consonant가 끼어도 적용된다는 점이다. <span style="color:#319795;">**creep [kʰɹiːp]**</span> 에서 /k/ 와 stressed vowel /iː/ 사이에 /r/ 이 있어도 /k/ 는 aspirated로 실현된다.

| 단어 | 전사 | 환경 |
|------|------|------|
| pit | [pʰɪt] | 어두 onset + 강세모음 앞 |
| pill | [pʰɪl] | 어두 onset + 강세모음 앞 |
| repeat | [ɹɪˈpʰiːt] | 강세 음절 [pʰiːt] onset |
| apart | [əˈpʰɑɹt] | 강세 음절 [pʰɑɹt] onset |
| creep | [kʰɹiːp] | onset + 개재 /r/ + 강세모음 |
...
<span style="color:#3182ce;">**VOT (Voice Onset Time)**</span>는 stop release와 following segment의 voicing 시작 사이의 시간 간격이다. VOT로 stop 세 유형을 구분할 수 있다.
...
표기상 <span style="color:#3182ce;">**aspiration diacritic**</span> 은 상첨자 **[ʰ]** 이며 aspirated consonant **뒤**에 붙인다([pʰ], [tʰ], [kʰ]). 자음 앞([ʰp])에 두면 오류다.
...
같은 onset cluster에서 /s/ 뒤에 오는 voiceless stop은 strong aspiration 환경에 들지 않으며, [p, t, k]로 실현된다.

stressed vowel 앞 syllable onset이라도 voiceless stop이 <span style="color:#c53030;">**/s/ 뒤**</span> 에 오면 aspiration이 억제되어 unaspirated로 실현된다. 이것이 minimal pair처럼 보이는 짝의 정체다.
...
|---|---|---|
| 기식 | strong aspiration | strong aspiration이 적용되지 않음 |
| 예 | top의 어두 /t/ → [tʰ] | top의 coda /p/ |
...
<span style="color:#c53030;">**⚠️ coda는 onset이 아니다**</span>: coda의 /p, t, k/(top의 /p/)에는 strong aspiration이 적용되지 않는다. aspiration의 핵심 환경은 onset이다.
