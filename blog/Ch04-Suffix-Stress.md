# 임용 음운론 Ch.4 Suffix-conditioned Stress — stress-bearing · neutral · shifting suffix 개념정리
...
suffix가 붙을 때 강세가 어디로 가는지가 임용 시험에서 핵심 판단 포인트다. suffix를 3가지 유형으로 나눠서 정확히 구별하는 것이 이 챕터의 목표다.

---

## 1. 세 가지 suffix 유형 — 핵심 분류

<span style="color:#3182ce;">**stress-bearing (attracting) suffix**</span>는 강세를 **suffix 자체**로 끌어당긴다.
<span style="color:#3182ce;">**stress-shifting (fixing) suffix**</span>는 강세를 **suffix 바로 앞 음절**로 고정한다.
<span style="color:#3182ce;">**stress-neutral suffix**</span>는 강세 위치를 **전혀 바꾸지 않는다**.
...
## 3. stress-shifting suffix — suffix 바로 앞 음절로

가장 출제 빈도가 높은 유형이다. suffix 바로 앞 음절에 강세가 온다.
...
<span style="color:#319795;">**포인트**</span> — 기본형의 강세가 suffix 바로 앞 음절에 이미 있으면 겉으로 보기에 "이동이 없는 것처럼" 보인다.
- divérse → divérsify → 이미 suffix 앞 음절이 강세 → 변화 없어 보임

---

## 4. stress-neutral suffix — 변화 없음
...
<span style="color:#dd6b20;">**쌤 팁**</span> — 파생어 강세 문제가 나오면 먼저 suffix를 분리하고, 그 suffix가 어느 유형인지 분류하는 게 우선이다. suffix 분류 → 규칙 적용 → IPA 확인 순으로.
...
*태그: 임용영어, 전공영어, 영어학, 음운론, phonology, suffix stress, stress-bearing, stress-neutral, stress-shifting, 임용고시*
